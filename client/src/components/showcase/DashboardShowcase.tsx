...
export default function DashboardShowcase() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden google-section">
        <div className="absolute inset-0 bg-gradient-to-r from-primary/3 via-primary/2 to-primary/3" />
        <div 
        ...
        <div className="google-container relative z-10">
          <div className="text-center space-y-3 sm:space-y-4 md:space-y-6 google-fade-in">
            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-accent text-accent-foreground rounded-full text-xs sm:text-sm font-medium">
              <Sparkles className="w-3 h-3 sm:w-4 sm:h-4" />
              <span>Featured Projects</span>
            </div>
            
            <h1 className="google-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl px-2">
              <span className="bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent">
                Portfolio Dashboard
              </span>
            </h1>
            
            <p className="google-body text-sm sm:text-base md:text-lg lg:text-xl max-w-2xl mx-auto px-4">
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 pt-2 sm:pt-4">
              <Button size="sm" className="group text-xs sm:text-sm md:text-base px-3 py-2 sm:px-4 sm:py-2 md:px-6 md:py-3">
                <span>View All Projects</span>
                <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 ml-1 sm:ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button size="sm" variant="outline" className="text-xs sm:text-sm md:text-base px-3 py-2 sm:px-4 sm:py-2 md:px-6 md:py-3">
