...
const fallbackProjects = [
  {
    ...
    description: "Solusi e-commerce lengkap dengan sistem pembayaran terintegrasi, manajemen inventory real-time, dan dashboard analytics yang powerful.",
  ...
  },
  {
    ...
    description: "Aplikasi mobile untuk layanan delivery dengan real-time tracking GPS, sistem pembayaran digital, dan notifikasi push.",
    image: "https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=600&h=400&fit=crop",
    category: "Mobile App",
    techStack: ["React Native", "Firebase", "Google Maps", "Redux"],
  ...
  },
  {
    ...
    description: "Website company profile dengan desain modern, optimasi SEO tingkat lanjut, dan sistem CMS untuk update konten.",
  ...
  },
  {
    ...
    description: "Platform manajemen bisnis terintegrasi dengan fitur CRM, inventory management, dan dashboard analytics.",
  ...
  },
  {
    ...
    description: "Sistem pembelajaran online dengan video streaming HD, quiz interaktif, progress tracking, dan sertifikat digital.",
    image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=600&h=400&fit=crop",
    category: "Web Application",
    techStack: ["React", "Next.js", "Prisma", "AWS S3"],
  ...
  },
  {
    ...
    description: "Aplikasi mobile untuk manajemen tugas dengan fitur kolaborasi tim, time tracking, dan sinkronisasi cloud.",
    image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=600&h=400&fit=crop",
    category: "Mobile App",
    techStack: ["React Native", "Redux", "Firebase", "AsyncStorage"],
  ...
  },
  {
    ...
    description: "Dashboard business intelligence dengan visualisasi data real-time, custom reports, dan integrasi multiple data sources.",
  ...
  },
  {
    ...
    description: "Aplikasi keuangan digital dengan fitur transfer uang, pembayaran tagihan, dan wallet digital yang aman.",
  ...
  },
  {
    ...
    description: "Platform media sosial dengan fitur posting, stories, live streaming, dan sistem notifikasi real-time.",
    image: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=600&h=400&fit=crop",
    category: "Web Application",
    techStack: ["React", "Socket.io", "Redis", "AWS S3"],
  ...
  },
  {
    ...
    description: "Aplikasi mobile untuk dating dan networking profesional dengan algoritma matching yang canggih.",
    image: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=600&h=400&fit=crop",
    category: "Mobile App",
    techStack: ["React Native", "Firebase", "ML Kit", "WebRTC"],
  ...
  },
  {
    ...
    description: "Website portfolio untuk fotografer dengan galeri interaktif, booking system, dan payment gateway.",
    image: "https://images.unsplash.com/photo-1452587925148-ce544e77e70d?w=600&h=400&fit=crop",
    category: "Web Development",
    techStack: ["React", "Next.js", "Sanity CMS", "Stripe"],
  ...
  },
  {
    ...
    description: "Platform streaming musik dengan fitur playlist, offline download, dan rekomendasi berbasis AI.",
  ...
  },
  {
    ...
    description: "Platform komunitas gaming dengan tournament system, leaderboard, dan live chat untuk gamers.",
  ...
  },
  {
    ...
    description: "Aplikasi mobile untuk travel planning dengan booking hotel, tiket pesawat, dan panduan wisata lokal.",
    image: "https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=600&h=400&fit=crop",
    category: "Mobile App",
    techStack: ["React Native", "Google Maps", "Stripe", "Firebase"],
  ...
  },
  {
    ...
    description: "Website restaurant dengan online ordering, delivery tracking, dan sistem reservasi meja.",
    image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=600&h=400&fit=crop",
    category: "Web Development",
    techStack: ["React", "Next.js", "Stripe", "Google Maps"],
  ...
  },
  {
    ...
    description: "Marketplace untuk freelancer dengan sistem bidding, escrow payment, dan rating system.",
...
export default function ProjectGalleryClean() {
          ...
          <div className="max-w-5xl mx-auto text-center google-fade-in">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 max-w-4xl mx-auto mb-8 sm:mb-12">
              {[
                ...
                { 
                  value: displayProjects?.filter(p => p.featured === 1 || p.featured === true).length || 0, 
                  label: "Featured", 
              ...
              {[
                {
                  ...
                  description: "Menggunakan React, Next.js, React Native, dan teknologi modern lainnya",
                  gradient: "from-blue-500 to-cyan-500"
                },
                {
                  icon: Award,
                  title: "Kualitas Premium",
                  description: "Setiap proyek dikerjakan dengan standar industri tertinggi",
                  gradient: "from-purple-500 to-pink-500"
                },
                {
                  icon: Clock,
                  title: "Pengalaman 5+ Tahun",
                  description: "Tim berpengalaman dengan track record yang terbukti",
                  gradient: "from-green-500 to-emerald-500"
                }
              ].map((feature, index) => (
                <div key={index} className="portfolio-card text-center google-fade-in" style={{ animationDelay: `${(index + 4) * 0.1}s` }}>
